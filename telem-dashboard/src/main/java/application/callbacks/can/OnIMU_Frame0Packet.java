...
public class OnIMU_Frame0Packet {

    public void handle(CANFrameParser.IMU_Frame0Packet p, MainPanel mainPanel, NotificationPanel notifications, TelemetryLookup lookup) {
