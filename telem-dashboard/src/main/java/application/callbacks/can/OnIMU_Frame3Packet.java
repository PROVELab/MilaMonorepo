...
public class OnIMU_Frame3Packet {

    public void handle(CANFrameParser.IMU_Frame3Packet p, MainPanel mainPanel, NotificationPanel notifications, TelemetryLookup lookup) {
        ...
        // You can access the data via p.dataName() methods, e.g., p.yaw_degrees()
