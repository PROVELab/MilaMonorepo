...
fn mcp3422_read16_mV_ch<I2C>(
    i2c: &mut I2C,
    addr7: u8,
    ch: u8,
) -> Result<i32, VsenseError<I2C::Error>> // Use the error type from the I2C instance
where
    I2C: I2c, 
{
...
pub fn read_mc_and_bat_mV<I2C>(
    i2c: &mut I2C,
    addr7: u8,
) -> Result<(i32, i32), VsenseError<I2C::Error>>
where
    I2C: I2c,
{
    // CH1 -> MC bus
