// This file is automatically generated by vsr_codegen.rs
...
static void print_motor_power(volatile vehicle_status_reg_s* vsr) {
    ...
    printf("  measured_dc_voltage_v (V): %.3f\n", (double) data.measured_dc_voltage_v);
    printf("  calculated_dc_current_a (A): %.3f\n", (double) data.calculated_dc_current_a);
    printf("  motor_current_limit_arms (A): %.3f\n", (double) data.motor_current_limit_arms);
}
...
static void print_motor_speed(volatile vehicle_status_reg_s* vsr) {
    ...
    printf("motor_speed:\n");
    print_timestamp_info("  ", timestamp_us);
    printf("  quadrature_current (Arms): %.3f\n", (double) data.quadrature_current);
    printf("  direct_current (Arms): %.3f\n", (double) data.direct_current);
    printf("  motor_speed (RPM): %" PRId16 "\n", (int16_t) data.motor_speed);
}
...
static void print_motor_safety(volatile vehicle_status_reg_s* vsr) {
    ...
    printf("motor_safety:\n");
    print_timestamp_info("  ", timestamp_us);
    printf("  protection_code: %" PRIu8 "\n", (uint8_t) data.protection_code);
    printf("  safety_error_code: %" PRIu8 "\n", (uint8_t) data.safety_error_code);
    printf("  motor_temp (F): %" PRId16 "\n", (int16_t) data.motor_temp);
    printf("  inverter_bridge_temp (F): %" PRId16 "\n", (int16_t) data.inverter_bridge_temp);
    printf("  bus_cap_temp (F): %" PRId16 "\n", (int16_t) data.bus_cap_temp);
    printf("  pwm_status: %" PRIu8 "\n", (uint8_t) data.pwm_status);
}
...
static void print_motor_control(volatile vehicle_status_reg_s* vsr) {
    ...
    print_timestamp_info("  ", timestamp_us);
    printf("  current_reference (Arms): %" PRId32 "\n", (int32_t) data.current_reference);
    printf("  discharge_limit_pct (%): %" PRIu8 "\n", (uint8_t) data.discharge_limit_pct);
    printf("  charge_limit_pct (%): %" PRIu8 "\n", (uint8_t) data.charge_limit_pct);
}
...
static void print_motor_error(volatile vehicle_status_reg_s* vsr) {
    ...
    printf("motor_error:\n");
    print_timestamp_info("  ", timestamp_us);
    printf("  motor_state: %s (%d)\n", motor_state_to_str((high_level_motor_state) data.motor_state), (int) data.motor_state);
}
...
static void print_pedal(volatile vehicle_status_reg_s* vsr) {
    ...
    printf("pedal:\n");
    print_timestamp_info("  ", timestamp_us);
    printf("  pedal_supply_voltage (mV): %.3f\n", (double) data.pedal_supply_voltage);
    printf("  pedal_position_pct (%): %.3f\n", (double) data.pedal_position_pct);
    printf("  pedal_raw_1: %.3f\n", (double) data.pedal_raw_1);
    printf("  pedal_raw_2: %.3f\n", (double) data.pedal_raw_2);
    printf("  tx_value: %" PRId32 "\n", (int32_t) data.tx_value);
...
static void print_motor_prot1(volatile vehicle_status_reg_s* vsr) {
    ...
    printf("motor_prot1:\n");
    print_timestamp_info("  ", timestamp_us);
    printf("  can_timeout_ms (ms): %" PRIu16 "\n", (uint16_t) data.can_timeout_ms);
    printf("  dc_regen_current_limit_neg_a (A): %" PRIu16 "\n", (uint16_t) data.dc_regen_current_limit_neg_a);
    printf("  dc_traction_current_limit_a (A): %" PRIu16 "\n", (uint16_t) data.dc_traction_current_limit_a);
    printf("  stall_protection_type: %" PRIu8 "\n", (uint8_t) data.stall_protection_type);
    printf("  stall_protection_time_ms (ms): %" PRIu16 "\n", (uint16_t) data.stall_protection_time_ms);
    printf("  stall_protection_current_a (A): %" PRIu16 "\n", (uint16_t) data.stall_protection_current_a);
    printf("  overspeed_protection_speed_rpm (RPM): %" PRIu8 "\n", (uint8_t) data.overspeed_protection_speed_rpm);
}
...
static void print_motor_prot2(volatile vehicle_status_reg_s* vsr) {
    ...
    printf("motor_prot2:\n");
    print_timestamp_info("  ", timestamp_us);
    printf("  max_motor_temp_c (C): %" PRIu8 "\n", (uint8_t) data.max_motor_temp_c);
    printf("  motor_temp_high_gain_a_per_c (A/C): %" PRIu8 "\n", (uint8_t) data.motor_temp_high_gain_a_per_c);
    printf("  max_inverter_temp_c (C): %" PRIu8 "\n", (uint8_t) data.max_inverter_temp_c);
    printf("  inverter_temp_high_gain_a_per_c (A/C): %" PRIu8 "\n", (uint8_t) data.inverter_temp_high_gain_a_per_c);
    printf("  id_overcurrent_limit_a (A): %" PRIu16 "\n", (uint16_t) data.id_overcurrent_limit_a);
    printf("  overvoltage_limit_v (V): %" PRIu16 "\n", (uint16_t) data.overvoltage_limit_v);
    printf("  shutdown_voltage_limit_v (V): %" PRIu16 "\n", (uint16_t) data.shutdown_voltage_limit_v);
}

static const vsr_topic_printer_t kTopics[] = {
    {.name = "motor_power", .print = &print_motor_power},
    {.name = "motor_speed", .print = &print_motor_speed},
    {.name = "motor_safety", .print = &print_motor_safety},
    {.name = "motor_control", .print = &print_motor_control},
    {.name = "motor_error", .print = &print_motor_error},
    {.name = "pedal", .print = &print_pedal},
    {.name = "motor_prot1", .print = &print_motor_prot1},
