...
CANFrame myframes[numFrames] = {
    {.numData = 2, .period = 500, .startingDataIndex=0, .dataInfo=f0DataPoints},
    {.numData = 5, .period = 1000, .startingDataIndex=2, .dataInfo=f1DataPoints},
};
