...
void ongenericVitalsCommand(genericVitalsCommand_args_t args) {
    ESP_LOGI(TAG, "Callback ongenericVitalsCommand called. vitalsCommands: %d", args.vitalsCommands);
...
void onset_telem_update_frequency_divider(set_telem_update_frequency_divider_args_t args) {
    ESP_LOGI(TAG, "Callback onset_telem_update_frequency_divider called. divider: %d", args.divider);
    // TODO: Implement logic for set_telem_update_frequency_divider
}

void onprechargeCommand(prechargeCommand_args_t args) {
    ESP_LOGI(TAG, "Callback onprechargeCommand called (packet was forwarded to prechargeID by Vitals). prechargeCommands: %d", args.prechargeCommands);
    // TODO: Implement logic for prechargeCommand
}

void onprechargeValue(prechargeValue_args_t args) {
    ESP_LOGI(TAG, "Callback onprechargeValue called (packet was forwarded to prechargeID by Vitals). value1: %d", args.value1);
    // TODO: Implement logic for prechargeValue
}

size_t onforward_packet(forward_packet_args_t args) {
    ESP_LOGI(TAG, "Callback onforward_packet called. CAN_ID: %d dataLength: %d extendedID: %d", args.CAN_ID, args.dataLength, args.extendedID);
