...
from Lora_Msgs_And_Cmds.genCANCallbacks import create_can_frame_callbacks
...
def generate_all_callbacks_and_skeletons(vitals_to_telem, telem_to_vitals, globalEnums, nodes, Presentation_path, Application_path, vitals_callbacks_dir):
    """
    Generates all visitor dispatchers and user-editable callback skeletons for
    vitals-to-telem, telem-to-vitals, and CAN frames.
    """
